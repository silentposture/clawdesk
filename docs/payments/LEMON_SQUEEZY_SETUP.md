...
- Never publish a private support address or private company identity in the repo.
- Use placeholder domains such as `clawdesk.example` in public docs.

## Placeholder product references

- Website: `https://clawdesk.example/`
- Product page: `https://clawdesk.example/clawdesk`
