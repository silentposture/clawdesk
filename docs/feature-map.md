...
- SSH terminal and remote desktop target adapters remain contract-only for execution; the registry UI, pairing/verification flow, and preview flow are now present.
