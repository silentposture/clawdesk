...
- Target list quick actions that execute the recommended next connection step directly from each target card: [`src/components/TargetRegistryPanel.tsx`](../src/components/TargetRegistryPanel.tsx)
