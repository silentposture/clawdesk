...
- [`scripts/prepare-host-agent-install-bundle.mjs`](../scripts/prepare-host-agent-install-bundle.mjs) turns that runtime into a concrete install bundle with launcher, install/remove wrappers, scheduled-task registration, and uninstall scripts.
