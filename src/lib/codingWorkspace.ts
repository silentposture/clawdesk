...
export interface GatewayAdapterMethod {
  ...
  | "targetsHostBridgeAttest"
  | "targetsHostBridgeHeartbeat"
  | "targetsConnection"
...
export const gatewayAdapterMethods: GatewayAdapterMethod[] = [
  ...
  { name: "targetsHostBridgeAttest", method: "POST", path: "/targets/host-bridge/attest", status: "partial", purpose: "由 host bridge 回報 device / install identity，讓已註冊主機能先完成 attestation 再進入連線。"},
